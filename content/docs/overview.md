...
icon: "circle"
toc: true
description: "Lily Docs is a modern documentation theme built for Hugo."
publishdate: "2022-09-30T05:33:22+01:00"
tags: ["Beginners"]
categories: [""]
---

{{< alert context="danger" text="We are currently updating the documentation." />}}

Welcome to the Lily Docs user guide. This guide shows you how to start creating technical documentation sites using Lily Docs, including site customisation and using Lily Docs' features and templates.

## What is Lily Docs?

Lily Docs is a theme for the [Hugo](https://gohugo.io) static site generator (SSG), specifically designed for technical documentation sets and includes many best practices by default (The site you’re currently reading was built using the Lily Docs theme!). Use Lily Docs to get a working and reliable documentation site [up and running]({{% relref "quickstart" %}}) fast, leaving valuable time to focus on creating content for your users.

### Features

Many of the [features]({{% relref "/docs/features" %}}) and [configurations]({{% relref "configuration" %}}) available in the Lily Docs theme are on display here in this documentation. You can clone this entire site and edit it to suit your projects, or explore the site, its source and see what Lily Docs can do. Check out a few of Lily Docs' features:
...
## Who is Lily Docs for?

Lily Docs is (currently) suited to small or medium technical documentation sets with 100 or fewer pages of docs. That's not to say Lily Docs won't scale to larger documentation sets, just that its navigation and site structure may not be sufficient for larger data sets without heavy customisation.

The good news is that development to accommodate such sites is part of the development roadmap. So keep an eye on the [Lily Docs GitLab repository](https://gitlab.com/oasci/lilydocs) for updates.
