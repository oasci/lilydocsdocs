...
title: "Configuration"
icon: settings
description: "A reference table of all available configurations options for the Lily Docs theme."
lead: ""
...
Social links are displayed as icons in the top left corner of the Lily Docs theme. This goes for the landing page and docs site.
...
Options to help you configure Lily Docs to suite your needs.
...
| Parameter | Type | Default Value | Description |
|---------|-----|-----|------|
| `title` | string | N/A | Set the default HTML title for your documentation pages/sections e.g. `Lily Docs` (This parameter is separate from the root Hugo [`title`](https://gohugo.io/getting-started/configuration/#title) parameter that sets the title for your site overall e.g the landing page.) |
| `pathName` | string | `docs` | Pathname for the documentation site. A few additional changes to the Lily Docs theme are required when this value is updated. See the **Installation** guide for more details. |
...
| Parameter | Type | Default Value | Description |
|---------|-----|-----|------|
| `repoURL` | string | N/A | Set the Git repository URL for your site e.g. `https://gitlab.com/oasci/lilydocs.dev` |
...
See the the [Plausible Analytics Guide]({{% relref "plausible-analytics" %}}) for more information about how to configure Plausible Analytics for your Lily Docs site.
