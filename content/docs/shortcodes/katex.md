...
weight: 1375
title: "KaTex"
description: "A Shortcode to render KaTex syntax in your Lily Docs site"
icon: "function"
...
Lily Docs has [built-in support]({{% relref "/docs/features/katex" %}}) for [KaTex](https://katex.org/). However, there are certain equation syntaxes which do not render well if at all without a lot of character escaping[^1] or alterations. The KaTex shortcode is suited to handle such cases.
